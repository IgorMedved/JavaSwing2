...
{
	private ServerTreeCellRenderer mRenderer;
	private JCheckBox mCheckBox;
	private ServerInfo mInfo;
	
	public ServerTreeCellEditor()
	{
		mRenderer= new ServerTreeCellRenderer();
	}
	...
	{
		mInfo.setChecked(mCheckBox.isSelected());
		return mInfo;
	}
	...
	public Component getTreeCellEditorComponent(JTree tree, Object value, boolean isSelected, boolean expanded, boolean leaf,
			int row)
	{
		Component component = mRenderer.getTreeCellRendererComponent(tree, value, isSelected, expanded, leaf, row, true);
		
		if(leaf)
		{
			DefaultMutableTreeNode treeNode = (DefaultMutableTreeNode)value;
			mInfo = (ServerInfo)treeNode.getUserObject();
			
			mCheckBox = (JCheckBox) component;
			...
			mCheckBox.addItemListener(itemListener);
		}
